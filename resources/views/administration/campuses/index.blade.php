...
<div class="flex h-full w-full flex-1 flex-col gap-6 p-1 sm:p-4 md:p-6"
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <h1 class="flex items-center gap-2 text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl"><flux:icon name="map-pin" class="size-16 text-[#0f766e]" /><span>Sedes</span></h1>
        ...
        <nav class="flex gap-1">
            <button
                ...
                :class="activeTab === 'list'
                    ? 'border-b-2 border-[#0f766e] text-[#0f766e] dark:text-teal-400'
