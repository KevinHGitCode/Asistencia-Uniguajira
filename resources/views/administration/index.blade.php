<x-layouts.app :title="__('Administración')">
    ...
    <div class="flex min-h-full w-full flex-1 flex-col gap-6 p-1 pb-8 sm:p-4 sm:pb-10 md:p-6 md:pb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            {{-- Card: Áreas (deshabilitado temporalmente — no se usa actualmente)
            ...
            <a href="{{ route('programs.index') }}"
               class="group relative flex flex-col gap-4 p-5 sm:p-6 rounded-2xl border border-neutral-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 overflow-hidden">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Gestiona programas, sede y tipo (Pregrado/Posgrado).
                    </p>
                </div>
            ...
            <a href="{{ route('banners.index') }}"
               class="group relative flex flex-col gap-4 p-5 sm:p-6 rounded-2xl border border-neutral-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 overflow-hidden">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Anuncios de patrocinadores en la página pública de registro por QR.
                    </p>
                </div>

                <div class="absolute bottom-0 left-0 w-0 h-0.5 rounded-b-xl bg-[#f97316] group-hover:w-full transition-all duration-300"></div>
            </a>
            @endif
            ...
            <a href="{{ route('organizations.index') }}"
               class="group relative flex flex-col gap-4 p-5 sm:p-6 rounded-2xl border border-neutral-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 overflow-hidden">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Gestiona organizaciones externas de participantes de comunidad.
                    </p>
                </div>

                <div class="absolute bottom-0 left-0 w-0 h-0.5 rounded-b-xl bg-[#8b5cf6] group-hover:w-full transition-all duration-300"></div>
            </a>
        ...
        <div class="mt-2 border border-neutral-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="px-4 sm:px-6 py-5 bg-white dark:bg-zinc-800">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div class="flex items-start gap-3">
                        <flux:icon.information-circle class="size-5 text-[#2563eb] mt-0.5 shrink-0" />
                        <span>Los <strong class="text-gray-800 dark:text-gray-200">programas</strong> permiten clasificar participantes por carrera, sede y tipo (Pregrado/Posgrado).</span>
                    </div>
                    <div class="flex items-start gap-3">
                    ...
                    @if(auth()->user()->isSuperadmin())
                    <div class="flex items-start gap-3">
                        <flux:icon.information-circle class="size-5 text-[#f97316] mt-0.5 shrink-0" />
                        <span>Los <strong class="text-gray-800 dark:text-gray-200">banners</strong> son anuncios de patrocinadores que rotan en la página pública de registro por QR; se cuentan impresiones y clics por banner.</span>
                    </div>
                    @endif
                </div>
            </div>
