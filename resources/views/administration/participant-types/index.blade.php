            ...
            <form
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="name" x-model="formName" x-ref="nameInput"
                        ...
                        required maxlength="100" placeholder="Ej: Egresado, Contratista…"
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500">
                        Debe coincidir exactamente con el valor en la columna
                        <code class="font-mono bg-zinc-100 dark:bg-zinc-800 px-1 rounded">Tipo de Estamento</code> del Excel.
                    </p>
                </div>
