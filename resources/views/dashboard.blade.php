    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-6">
        ...
        <div class="grid auto-rows-min gap-6 md:grid-cols-3">
            ...
            <div class="relative overflow-hidden rounded-xl bg-gray-800 border border-gray-700 p-6 hover:bg-gray-750 transition-colors">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-medium text-gray-200 mb-2">Próximos eventos</h3>
                        <div class="flex items-center gap-3">
                            <div class="p-3 bg-yellow-600 rounded-lg">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
        ...
        <div class="relative flex-1 overflow-hidden rounded-xl bg-gray-800 border border-gray-700 p-6">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-white mb-2">Calendario de Eventos</h2>
                <p class="text-gray-400">Vista mensual de eventos programados</p>
            </div>
            
            <!-- Contenedor del calendario responsivo -->
            <div class="h-full min-h-96 w-full overflow-auto">
                <div id="cal-heatmap" class="w-full h-full"></div>
                @vite('resources/js/calendar.js')
            </div>
        </div>
    </div>
