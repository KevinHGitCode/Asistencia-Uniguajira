<x-layouts.app :title="__('Statistics')">
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-2xl">
        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div id="chart_bar" class="relative aspect-video overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-700"></div>
            <div id="chart_line" class="relative aspect-video overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-700"></div>
            <div id="chart_pie" class="relative aspect-video overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-700"></div>
        </div>

        <!-- Gráfico ancho abajo -->
        <div id="chart_radar" class="relative h-full flex-1 overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-700"></div> --}}
        @php
