<div x-show="showDelete"
        ...
        <div x-show="showDelete"
            ...
            <div class="text-center">
                <h3 class="text-base font-semibold text-gray-900 dark:text-white mb-1">Eliminar organización?</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Estas por eliminar <strong class="text-gray-800 dark:text-gray-200" x-text="`&quot;${deleteName}&quot;`"></strong>.
                    Esta accion no se puede deshacer.
                </p>
            </div>

            <form
                :action="'{{ route('organizations.destroy', '__id__') }}'.replace('__id__', deleteId)"
                method="POST"
                class="flex gap-3">
                @csrf
                @method('DELETE')
