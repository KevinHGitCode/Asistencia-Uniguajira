        ...
        <div x-show="showForm"
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-neutral-200 dark:border-zinc-700">
                <h3 class="text-base font-semibold text-gray-900 dark:text-white"
                    x-text="editingId ? 'Editar Organización' : 'Nueva Organización'"></h3>
            ...
            <form
                :action="editingId
                    ? '{{ route('organizations.update', '__id__') }}'.replace('__id__', editingId)
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="name" x-model="formName" x-ref="nameInput"
                        ...
                        required maxlength="150" placeholder="Ej: Alcaldía de Riohacha"
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button type="submit"
                        ...
                        x-text="editingId ? 'Guardar cambios' : 'Crear organización'">
                    </button>
                </div>
            </form>
        </div>
