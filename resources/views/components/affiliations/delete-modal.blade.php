<div x-show="showDelete"
        ...
        <div x-show="showDelete"
            ...
            <div class="text-center">
                <h3 class="text-base font-semibold text-gray-900 dark:text-white mb-1">Eliminar afiliacion?</h3>
            ...
            <form
                :action="'{{ route('affiliations.destroy', '__id__') }}'.replace('__id__', deleteId)"
                method="POST"
                class="flex gap-3">
                @csrf
                @method('DELETE')
