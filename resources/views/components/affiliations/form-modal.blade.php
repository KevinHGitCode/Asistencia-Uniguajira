        ...
        <div x-show="showForm"
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-neutral-200 dark:border-zinc-700">
                <h3 class="text-base font-semibold text-gray-900 dark:text-white"
                    x-text="editingId ? 'Editar Afiliacion' : 'Nueva Afiliacion'"></h3>
            ...
            <form
                :action="editingId
                    ? '{{ route('affiliations.update', '__id__') }}'.replace('__id__', editingId)
                    : '{{ route('affiliations.store') }}'"
                method="POST"
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="name" x-model="formName" x-ref="nameInput"
                        x-init="$watch('showForm', v => v && $nextTick(() => $refs.nameInput.focus()))"
                        required maxlength="100" placeholder="Ej: Catedratico"
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500">
                        Ejemplos: Catedratico, Ocasional, Planta, Contratista...
                    </p>
                </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button type="submit"
                        ...
                        x-text="editingId ? 'Guardar cambios' : 'Crear afiliacion'">
                    </button>
                </div>
            </form>
        </div>
