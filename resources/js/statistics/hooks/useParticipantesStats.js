...
function buildQS(filters, eventIds = null) {
  return buildStatisticsQuery(filters, eventIds);
}
    ...
    try {
      ...
      setState({
        ...
        charts: {
          ...
          participantsByDependency:   data.charts.participantsByDependency   ?? [],
          participantsByOrganization: data.charts.participantsByOrganization ?? [],
          participantsUnclassified:   data.charts.participantsUnclassified   ?? 0,
