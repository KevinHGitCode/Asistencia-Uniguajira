    ...
    try {
      ...
      setState({
        ...
        charts: {
          ...
          attendancesByDependency:   data.charts.attendancesByDependency   ?? [],
          attendancesByOrganization: data.charts.attendancesByOrganization ?? [],
          attendancesUnclassified:   data.charts.attendancesUnclassified   ?? 0,
